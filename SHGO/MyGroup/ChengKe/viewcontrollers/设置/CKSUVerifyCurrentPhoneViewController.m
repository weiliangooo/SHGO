...
@interface CKSUVerifyCurrentPhoneViewController ()
{
    ///定时器
    NSTimer * timer;
    ///默认60 倒计时
...
@implementation CKSUVerifyCurrentPhoneViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.type = 5;
    self.topTitle = @"验证当前手机号";
    self.view.backgroundColor = [UIColor colorWithHexString:@"#f4f4f4"];
    
    _accountTF = [[CKLoginTextField alloc] initWithFrame:CGRectMake(20*PROPORTION750, 30*PROPORTION750, AL_DEVICE_WIDTH-40*PROPORTION750, 90*PROPORTION750) leftImgName:@"shouj" placeholderTitle:@"请输入当前手机号码"];
...
-(void)buttonClickEvents:(UIButton *)button
{
    ...
    else if (button.tag == 101)
    {
        ...
        CKSUVerifyNewPhoneViewController *viewController = [[CKSUVerifyNewPhoneViewController alloc] init];
