//
//  CKDiscountRegularViewController.m
//  SHGO
//
...
@interface CKDiscountRegularViewController ()

@end

@implementation CKDiscountRegularViewController
...
- (void)viewDidLoad {
    ...
    q1LB.attributedText = [self stringForQuestion:YES inputStr:@"Q 一辆车最多使用几张优惠券？"];
    ...
    a1LB.attributedText = [self stringForQuestion:NO inputStr:@"A 一个小马出行订单最多能够使用一张优惠券。"];
    ...
    q2LB.attributedText = [self stringForQuestion:YES inputStr:@"Q 什么是优惠券？"];
    q2LB.textAlignment = NSTextAlignmentLeft;
    [myView addSubview:q2LB];
    
    UILabel *a2LB = [[UILabel alloc] initWithFrame:CGRectMake(50*PROPORTION750, q2LB.bottom+30*PROPORTION750, myView.width-100*PROPORTION750, 70*PROPORTION750)];
    a2LB.attributedText = [self stringForQuestion:NO inputStr:@"A 是小马出行发放给用户，在乘做车后，用于抵扣订单金额的电子券。"];
    a2LB.textAlignment = NSTextAlignmentLeft;
    a2LB.font = SYSF750(25);
    a2LB.numberOfLines = 2;
